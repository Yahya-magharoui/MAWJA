...
export default function AnchoringHub() {
  return (
    <main style={wrap}>
      ...
      <section style={grid}>
        <a
          href="/exercice/breathing/Coherence"
          onMouseDown={vibe}
          style={{ ...card, background:'linear-gradient(180deg, rgba(var(--theme-color-rgb),0.133) 0%, rgba(var(--theme-color-rgb),0.07) 100%)' }}
          className="tile"
        >
          <div style={iconWrap}>
            <img
              src="/icons/coherence.svg"
              alt="Coherence Cardiaque"
              width={44}
              height={44}
          ...
          <div style={label}>Coherence Cardiaque</div>
        </a>

        <a
          href="/exercice/breathing/abdominal"
          onMouseDown={vibe}
          style={{ ...card, background:'linear-gradient(180deg, rgba(var(--theme-color-rgb),0.133) 0%, rgba(var(--theme-color-rgb),0.07) 100%)' }}
          className="tile"
        >
          <div style={iconWrap}>
            <img
              src="/icons/abdominal.svg"
              alt="Respiration abdominale"
              width={44}
              height={44}
              style={{ display:'block', objectFit:'contain' }}
              loading="lazy"
          ...
          <div style={label}>Respiration abdominale</div>
        </a>
      </section>
